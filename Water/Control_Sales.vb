...
Public Class Control_Sales
    ...
    Public Sub Load_Transaction_Table()
        ...
        Try
            MySQLConn.Open()
            query = "SELECT transactionnum AS 'Transaction Number', customername AS 'Customer Name', productname AS 'Product Name', productprice AS 'Price', transactiondate AS 'Date' FROM transac_table;"
    ...
    Private Sub Button_Filter_Click(sender As System.Object, e As System.EventArgs) Handles Button_Filter.Click
        ...
        Try
            MySQLConn.Open()
            query = "SELECT transactionnum AS 'Transaction Number', customername AS 'Customer Name', productname AS 'Product Name', productprice AS 'Price', transactiondate AS 'Date' FROM transac_table WHERE transactiondate BETWEEN @startdate AND @enddate"
            comm = New MySqlCommand(query, MySQLConn)
            adapter.SelectCommand = comm
